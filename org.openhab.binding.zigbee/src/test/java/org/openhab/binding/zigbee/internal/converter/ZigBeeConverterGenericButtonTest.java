...
public class ZigBeeConverterGenericButtonTest {
    ...
    public void attributeWithMatchingValueIsHandled() {
        ...
        ZclAttribute attribute = new ZclAttribute(ZclStandardClusterType.MULTISTATE_INPUT_BASIC, 85, "foo",
    ...
    public void attributeTypeIsCorrectlyDetected() {
        ...
        ZclAttribute attribute = new ZclAttribute(ZclStandardClusterType.MULTISTATE_INPUT_BASIC, 0x17, "foo",
                ZclDataType.UNSIGNED_16_BIT_INTEGER, false, false, true, true);
        attribute.updateValue(2);
        converter.attributeUpdated(attribute);
