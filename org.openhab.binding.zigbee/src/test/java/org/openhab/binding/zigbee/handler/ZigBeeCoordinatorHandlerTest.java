...
public class ZigBeeCoordinatorHandlerTest {
    ...
    public void testInstallCode() throws NoSuchFieldException, SecurityException, IllegalArgumentException,
        ...
        ArgumentCaptor<IeeeAddress> addressCapture = ArgumentCaptor.forClass(IeeeAddress.class);
        ArgumentCaptor<ZigBeeKey> keyCapture = ArgumentCaptor.forClass(ZigBeeKey.class);
        Mockito.when(networkManager.setZigBeeInstallKey(addressCapture.capture(), keyCapture.capture()))
                .thenReturn(true);
        ...
        assertEquals(new IeeeAddress("1122334455667788"), addressCapture.getValue());
