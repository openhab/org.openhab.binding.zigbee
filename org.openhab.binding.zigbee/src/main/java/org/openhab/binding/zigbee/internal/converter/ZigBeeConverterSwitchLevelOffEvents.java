...
/**
 * This channel supports triggering events related to the off button of the ZigBeeConverterSwitchLevel
 *
 * @author Jörg Sautter - Initial Contribution
 *
 */
public class ZigBeeConverterSwitchLevelOffEvents extends ZigBeeBaseChannelConverter {
    private final Logger logger = LoggerFactory.getLogger(ZigBeeConverterSwitchLevelOffEvents.class);
    ...
    public Channel getChannel(ThingUID thingUID, ZigBeeEndpoint endpoint) {
        ...
        return ChannelBuilder
                .create(createChannelUID(thingUID, endpoint, ZigBeeBindingConstants.CHANNEL_NAME_SWITCH_LEVEL_OFF_EVENTS))
                .withKind(ChannelKind.TRIGGER)
                .withType(ZigBeeBindingConstants.CHANNEL_SWITCH_LEVEL_OFF_EVENTS)
                .withLabel(getDeviceTypeLabel(endpoint) + ": " + ZigBeeBindingConstants.CHANNEL_LABEL_SWITCH_LEVEL_OFF_EVENTS)
    ...
    public void planChannelEvent() {
        logger.debug("{}: Plan off event to channel {}", endpoint.getIeeeAddress(), channelUID);
