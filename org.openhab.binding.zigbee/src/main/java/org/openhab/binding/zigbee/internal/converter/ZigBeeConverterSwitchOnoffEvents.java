...
/**
 * This channel supports triggering events related to the ZigBeeConverterSwitchOnoff
 *
 * @author Jörg Sautter - Initial Contribution
 *
 */
public class ZigBeeConverterSwitchOnoffEvents extends ZigBeeBaseChannelConverter {
    ...
    public Channel getChannel(ThingUID thingUID, ZigBeeEndpoint endpoint) {
        ...
        return ChannelBuilder
                .create(createChannelUID(thingUID, endpoint, ZigBeeBindingConstants.CHANNEL_NAME_SWITCH_ONOFF_EVENTS))
                .withKind(ChannelKind.TRIGGER)
                .withType(ZigBeeBindingConstants.CHANNEL_SWITCH_ONOFF_EVENTS)
                .withLabel(getDeviceTypeLabel(endpoint) + ": " + ZigBeeBindingConstants.CHANNEL_LABEL_SWITCH_ONOFF_EVENTS)
