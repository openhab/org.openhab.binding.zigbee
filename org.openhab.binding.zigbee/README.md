...
| [Elelabs ELU013/ELR023](https://elelabs.com/shop/)                                                                                                    | [Ember](#ember-ezsp-ncp-coordinator) | 115200bps<br>Hardware&nbsp;flow&nbsp;control<br>High RAM | Both the stick and the hat can be upgraded without additional hardware, firmware available [here](https://github.com/Elelabs/elelabs-zigbee-ezsp-utility)<br>Some users reported troubles if [`Network Size (zigbee_networksize)`](#network-size-zigbee_networksize) is set over `25`.                                                                                                                                     |
