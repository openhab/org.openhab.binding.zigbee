...
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | 
| [Sonoff Zigbee 3.0 USB Dongle Plus V2](https://sonoff.tech/product/gateway-and-sensors/sonoff-zigbee-3-0-usb-dongle-plus-e/)                                                                                                    | [Ember](#ember-ezsp-ncp-coordinator) | 115200bps<br>Hardware&nbsp;flow&nbsp;control<br>High RAM | USB dongle based on Silicon Labs EFR32MG21 MCU. EmberZNet Zigbee NCP (coordinator) firmware image builds from ITead are available [here](https://github.com/itead/Sonoff_Zigbee_Dongle_Firmware/tree/master/Dongle-E). Make sure to get the "Plus V2"-Version (model: ZBDongle-E, SoC: EFF32MG21, USB Serial Chip: CH9102F), as the "Plus"-Version (without "V2" at the end: model: ZBDongle-P, SoC: CC2652P, USB Serial Chip: CP2102(N)) won't work with this binding, but only with Zigbee2MQTT. See [here](https://community.openhab.org/t/solved-how-to-setup-the-sonoff-zigbee-usb-dongle/139364/12?u=cplant) for more details.                                                                                                  |
