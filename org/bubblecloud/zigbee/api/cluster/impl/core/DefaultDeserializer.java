...
public class DefaultDeserializer implements ZBDeserializer {
    ...
    // Quellcode Nathi
    public long read_uint32bit() {
        long value = Integers.readUInt32(payload, index);
    ...
    public Object readZigBeeType(ZigBeeType type) {
        ...
        switch (type) {
            ...
            case SignedInteger32bit:
                int si32 = read_int();
                value[0] = new Integer(si32);
                break;
            case UnsignedInteger32bit:
                long ui32 = read_uint32bit();
                value[0] = new Long(ui32);
                break;
            // ENde Quellcode Nathi
            ...
            case SinglePrecision: {
                float fnumber = read_float();
                value[0] = new Float(fnumber);
            }
                break;
            default:
                throw new IllegalArgumentException("No reader defined by this " + ZBDeserializer.class.getName()
