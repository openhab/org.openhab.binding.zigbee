...
public interface ColorSensorMeasurement extends ZCLCluster {

    static final short ID = 0x000C;
    static final String NAME = "Color Sensor";
    static final String DESCRIPTION = "Attributes and commands for configuring the measurement"
            + " of color, and reporting pressure measurements";
