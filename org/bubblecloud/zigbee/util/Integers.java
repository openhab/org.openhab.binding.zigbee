...
public class Integers {
    ...
    // Quellcode Nathi
    public static long readUInt32(byte[] src, int pos) {
        return ((src[pos + 3] & 0x00000000000000FF) << 24) + ((src[pos + 2] & 0x00000000000000FF) << 16)
                + ((src[pos + 1] & 0x00000000000000FF) << 8) + ((src[pos] & 0x00000000000000FF));
