...
public class ZigBeeNetworkManagerImpl implements ZigBeeNetworkManager {
    ...
    // The dongle will use he current channel if set
    private final byte AUTO_CHANNEL = -1;
    ...
    private boolean checkZigBeeNetworkConfiguration() {
        ...
        value = getCurrentChannel();

        // If channel is set to 0xff, just use the current channel  
