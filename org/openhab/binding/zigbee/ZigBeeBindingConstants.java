...
public class ZigBeeBindingConstants {
    ...
    public final static String CHANNEL_BASIC = "basic_device_information";
    public final static String CHANNEL_IDENTIFY = "device_identification";
    public final static String CHANNEL_GROUPS = "device_group";
    public final static String CHANNEL_SCENES = "device_scene";
    public final static String CHANNEL_TEMPERATURE = "temperature";
    public final static String CHANNEL_HUMIDITY = "measurement_relative_humidity";
    public final static String CHANNEL_PRESSURE = "measurement_pressure";
    public final static String CHANNEL_ELECTRICAL_CURRENT = "measurement_electrical";
    public final static String CHANNEL_ELECTRICAL_VOLTAGE = "measurement_electrical";
