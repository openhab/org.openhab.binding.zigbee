...
public abstract class ZigBeeClusterHandler {
    ...
    public static ZigBeeClusterHandler getConverter(int clusterId) {
        if (clusterMap == null) {
            ...
            // clusterMap.put(ZigBeeApiConstants.CLUSTER_ID_BASIC, ZigBeeBasicClusterHandler.class);
            // clusterMap.put(ZigBeeApiConstants.CLUSTER_ID_IDENTIFY, ZigBeeIdentifyClusterHandler.class);
            // clusterMap.put(ZigBeeApiConstants.CLUSTER_ID_GROUPS, ZigBeeGroupsClusterHandler.class);
            // clusterMap.put(ZigBeeApiConstants.CLUSTER_ID_SCENES, ZigBeeScenesClusterHandler.class);
            ...
            clusterMap.put(ZigBeeApiConstants.CLUSTER_ID_PRESSURE_MEASUREMENT,
                    ZigBeePressureMeasurementClusterHandler.class);
            clusterMap.put(ZigBeeApiConstants.CLUSTER_ID_ELECTRICAL_MEASUREMENT,
                    ZigBeeElectricalCurrentMeasurementClusterHandler.class);
            // clusterMap.put(ZigBeeApiConstants.CLUSTER_ID_ELECTRICAL_MEASUREMENT,
            // ZigBeeElectricalVoltageMeasurementClusterHandler.class);
            clusterMap.put(ZigBeeApiConstants.DEVICE_ID_HA_SIMPLE_SENSOR,
                    ZigBeeColorSensorMeasurementClusterHandler.class);
    ...
    public void updateChannelState(State state) {
