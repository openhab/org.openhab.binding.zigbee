...
public class ZigBeeCoordinatorCC2530Handler extends ZigBeeCoordinatorHandler
    ...
    private void openSerialPort(final String serialPortName, int baudRate) {
        ...
        try {
            ...
            logger.error("Serial Error: Too many listiners on Port {} ", serialPortName);
            e.printStackTrace();
            return;
        }
        ...
        try {
            ...
            logger.error("Serial Error: could not read or write data from/for Prot {}", serialPortName);
            e.printStackTrace();
        }
    ...
    public void close() {
        try {
            ...
            logger.warn("Error closing serial port: '" + serialPort.getName() + "'", e);
        }
    }
